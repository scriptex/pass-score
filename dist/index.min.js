 ...
 *
 * @return {Number}
 */a["default"]=function passScore(a){var c=1<arguments.length&&arguments[1]!==void 0?arguments[1]:b;"undefined"==typeof a&&(a="");// Convert everything to empty string
try{a=a.toString()}catch(b){// If null - convert to empty string
a=""}return c.reduce(function(b,c){return b+c.test(a)},0)}});
